-- H2-compatible V11: Quartz 2.3 JDBC job store schema
-- Used only in the test profile with H2 in PostgreSQL compatibility mode.
-- In tests, spring.quartz.job-store-type=memory, so Quartz never reads these tables.
-- This migration exists only to keep Flyway version parity with the main migration set.
...
CREATE TABLE qrtz_calendars (
    ...
    calendar      BINARY VARYING NOT NULL,
