-- V11: Quartz 2.3 JDBC job store schema for PostgreSQL
...
--
-- Flyway owns this schema; application.properties sets
--   spring.quartz.jdbc.initialize-schema=never
-- so Quartz does NOT attempt to auto-create or drop these tables.
